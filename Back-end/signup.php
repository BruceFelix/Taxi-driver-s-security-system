...
$insert_details = "INSERT INTO driversdetails(name,phonenumber,carplates,carmodel,password) VALUES('$username','$phone_number','$carplates','$carmodel','$password')";

//checking if user email already exists
$getRecords = "SELECT phonenumber FROM driversdetails WHERE phonenumber ='$phone_number'";
