...
// }
$tableCreator = "CREATE TABLE usersdetails (id int auto_increment, name varchar(30), primary key(id),phonenumber int(50),carplates varchar(30) ,carmodel varchar(50), password varchar(253))";
